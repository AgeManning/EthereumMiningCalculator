  ...
  .factory('EtherscanDataService', ['$http', function($http) {
     ...
     */
     factory.getDifficultyData = function(blockNo) {
      ...
      return $http.get("https://api.etherscan.io/api?module=proxy&action=eth_getBlockByNumber&tag=" + hexBlockNo + "&boolean=true")
     ...
     factory.getMinedBlocks = function(address){
      return $http.get("https://api.etherscan.io/api?module=account&action=getminedblocks&address=" + address + "&blocktype=blocks")
        .then(function(result) {
